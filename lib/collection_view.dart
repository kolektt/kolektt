...
class _EditRecordViewState extends State<EditRecordView> {
  ...
  void initState() {
    ...
    catalogNumberController = TextEditingController(text: widget.record.catalogNumber ?? "");
    ...
    conditionNotesController = TextEditingController(text: widget.record.conditionNotes ?? "");
  }
        ...
        child: Padding(
          ...
          child: ListView(
            children: [
              ...
              // 예시로 CupertinoSegmentedControl으로 상태 선택 구현 가능
              DropdownButton<String>(
